 ...
 */
@Component
public class SaveAuthLevelAttributeDispatcher extends AbstractAPIDispatcher<BaseGrudServiceRequest<AuthLevelAttribute>, StringResponse, ContentProviderAPI> {
    @Autowired
    ...
    @Override
    protected StringResponse processingApiRequest(ContentProviderAPI openIAMAPI, BaseGrudServiceRequest<AuthLevelAttribute> request) throws BasicDataServiceException {
