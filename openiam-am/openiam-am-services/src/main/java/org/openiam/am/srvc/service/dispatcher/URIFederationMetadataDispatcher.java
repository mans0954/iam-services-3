 ...
 */
@Component
public class URIFederationMetadataDispatcher extends AbstractAPIDispatcher<URIFederationServiceRequest, URIFederationResponse, OpenIAMAPICommon> {
    @Autowired
    ...
    @Override
    protected URIFederationResponse processingApiRequest(OpenIAMAPICommon openIAMAPI, URIFederationServiceRequest uriFederationServiceRequest) throws BasicDataServiceException {
