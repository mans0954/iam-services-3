 ...
 */
@Component
public class SaveUriPatternDispatcher extends AbstractAPIDispatcher<BaseGrudServiceRequest<URIPattern>, StringResponse, ContentProviderAPI> {
    @Autowired
    ...
    @Override
    protected StringResponse processingApiRequest(ContentProviderAPI openIAMAPI, BaseGrudServiceRequest<URIPattern> request) throws BasicDataServiceException {
