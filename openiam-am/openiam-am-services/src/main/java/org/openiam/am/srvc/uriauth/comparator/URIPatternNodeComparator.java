...
import org.openiam.am.srvc.uriauth.model.URIPatternNode;
import org.openiam.am.srvc.uriauth.model.URIPatternToken;
...
public class URIPatternNodeComparator implements Comparator<URIPatternNode> {
	...
	public int compare(URIPatternNode node1, URIPatternNode node2) {
		final URIPatternToken token1 = node1.getToken();
		final URIPatternToken token2 = node2.getToken();
