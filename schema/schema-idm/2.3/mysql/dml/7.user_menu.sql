...
DELETE FROM  RESOURCE_PROP WHERE RESOURCE_ID = 'USER';

DELETE FROM RESOURCE_ROLE where RESOURCE_ID in ('USER_MENU_ROOT', 'USER_EDIT_MENU_ROOT','ADDUSER','NEW_USER','USERSUMMARY','USERROLE',
                                                'USERPSWDRESET','USERORG','USERORG','USERIDENTITY','USERHISTORY','USERGROUP','USERATTR','QUERYUSER');
DELETE FROM  res_to_res_membership WHERE RESOURCE_ID in ('USER_MENU_ROOT', 'USER_EDIT_MENU_ROOT');
...
INSERT INTO RES (RESOURCE_ID, RESOURCE_TYPE_ID, NAME, DESCRIPTION, URL, DISPLAY_ORDER) VALUES('USER_SUPERVISOR_INFO', 'MENU_ITEM', 'USER_SUPERVISOR_INFO', 'Edit User Supervisor Info','/webconsole/editUserSupervisor.html',5);
INSERT INTO RESOURCE_PROP (RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUES ('USER_SUPERVISOR_INFO_PUB', 'USER_SUPERVISOR_INFO', 'MENU_IS_PUBLIC', 'true');
INSERT INTO RESOURCE_PROP (RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUES ('USER_SUPERVISOR_INFO_DESC', 'USER_SUPERVISOR_INFO', 'MENU_DISPLAY_NAME', 'Contact Info');
...
INSERT INTO res_to_res_membership (RESOURCE_ID, MEMBER_RESOURCE_ID) VALUES('USER_EDIT_MENU', 'USER_SUPERVISOR_INFO');
