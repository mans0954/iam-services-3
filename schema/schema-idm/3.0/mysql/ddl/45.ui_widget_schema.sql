...
ALTER TABLE USER_ATTRIBUTES ADD METADATA_ELEMENT_ID VARCHAR(32) NULL;
ALTER TABLE USER_ATTRIBUTES ADD CONSTRAINT USER_ATTR_METADATA_ELEMENT_FK FOREIGN KEY (METADATA_ELEMENT_ID) REFERENCES METADATA_ELEMENT(METADATA_ID);