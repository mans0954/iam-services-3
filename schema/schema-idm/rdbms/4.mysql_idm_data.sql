...
INSERT INTO GRP_ROLE(ROLE_ID,GRP_ID) VALUES ('SUPER_SEC_ADMIN','SUPER_SEC_ADMIN_GRP');
INSERT INTO GRP_ROLE(ROLE_ID,GRP_ID) VALUES ('END_USER','END_USER_GRP');

INSERT INTO GRP_ROLE(ROLE_ID,GRP_ID) VALUES ('HR','HR_GRP');
INSERT INTO GRP_ROLE(ROLE_ID,GRP_ID) VALUES ('MANAGER','MNGR_GRP');
INSERT INTO GRP_ROLE(ROLE_ID,GRP_ID) VALUES ('SECURITY_MANAGER','SECURITY_GRP');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('BATCH_PROC','SUPER_SEC_ADMIN');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('LOCATION','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('ORGPOLICY','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SYSNOTIFICATION','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('CHALLENGE','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('REFDATA','SUPER_SEC_ADMIN');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USER_BULK','SUPER_SEC_ADMIN');

INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SYNCUSER','SUPER_SEC_ADMIN');

INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SYNCDETAIL','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SYNCLOG','SUPER_SEC_ADMIN');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('DELG_FILTER','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERATTR','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERORG','SUPER_SEC_ADMIN');

INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('RESSUMMARY','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('RESPOLICYMAP','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('RESAPPROVER','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('RESRECONCILE','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('RESENTITLEMENT','SUPER_SEC_ADMIN');


INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('ROLE_SUMMARY','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('ROLE_RESMAP','SUPER_SEC_ADMIN');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SECURITY_RES','SUPER_SEC_ADMIN');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELF_REGISTER','END_USER');

INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('REQINBOX','END_USER');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('NEWUSER','END_USER');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('NEWUSER-NOAPPRV','END_USER');



INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('REQINBOX','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('MANAGEREQ','SUPER_SEC_ADMIN');

INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELF_USERSUMMARY','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELF_USERIDENTITY','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELF_USERGROUP','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELF_USERROLE','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELF_USERPSWDRESET','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELF_QUERYUSER','HELPDESK');

INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELFSERVICE','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('ACCESSCENTER','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('MANAGEREQ','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('SELFCENTER','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('DIRECTORY','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('CHNGPSWD','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('IDQUEST','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('PROFILE','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('CREATEREQ','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('NEWUSER','HELPDESK');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('NEWUSER-NOAPPRV','HELPDESK');
...
INSERT INTO USER_ROLE (USER_ROLE_ID,ROLE_ID, USER_ID, STATUS) VALUES('101','HELPDESK','3010','ACTIVE');
