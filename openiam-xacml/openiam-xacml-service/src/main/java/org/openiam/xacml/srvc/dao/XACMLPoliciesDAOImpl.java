 ...
 */
@Repository("xacmlPoliciesDao")
public class XACMLPoliciesDAOImpl extends BaseDaoImpl<XACMLPolicySetEntity, String> implements XACMLPolicySetDAO {
    @Override
    ...
    @Override
    protected Criteria getExampleCriteria(final XACMLPolicySetEntity policyEntity) {
        ...
        if (StringUtils.isNotBlank(policyEntity.getId())) {
            ...
            if (StringUtils.isNotEmpty(policyEntity.getVersion())) {
                criteria.add(Restrictions.eq("version", policyEntity.getVersion()));
            }
            if (StringUtils.isNotEmpty(policyEntity.getIssuer())) {
                criteria.add(Restrictions.eq("issuer", policyEntity.getIssuer()));
            }
            if (StringUtils.isNotEmpty(policyEntity.getPolicySetDefaults())) {
                criteria.add(Restrictions.eq("policySetDefaults", policyEntity.getPolicySetDefaults()));
            }
        }
        return criteria;
    }
