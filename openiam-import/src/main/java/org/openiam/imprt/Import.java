...
public class Import {
    ...
    private static final String SERVER_MODE_PREFIX;
    ...
    static {
        ...
        SERVER_MODE_PREFIX = String.format("--%s=", SERVER_MODE);
    }
    ...
    public static void main(String[] args) {
        ...
        for (String param : args) {
            ...
            } else if (param.contains(SERVER_MODE_PREFIX)) {
                parseArg(param, SERVER_MODE_PREFIX, SERVER_MODE, ImportPropertiesKey.SERVER_MODE);
            }
        }
