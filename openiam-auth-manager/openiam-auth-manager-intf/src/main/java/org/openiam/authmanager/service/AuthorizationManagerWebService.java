...
public interface AuthorizationManagerWebService {
	...
	@WebMethod
	List<String> isUserEntitledToResources(
	...
	@WebMethod
	boolean isUserEntitledToResource(
			@WebParam(name = "userId", targetNamespace = "") final String userId,
	 ...
	 */
	@WebMethod
	AccessResponse isUserEntitledTo(
	 ...
	 */
	@WebMethod
	AccessResponse isMemberOfGroup(
	 ...
	 */
	@WebMethod
	ResourcesForUserResponse getResourcesFor(
	 ...
	 */
	@WebMethod
	GroupsForUserResponse getGroupsFor(
			@WebParam(name = "request", targetNamespace = "") final UserRequest request
	);
	 ...
	 */
	@WebMethod
	RolesForUserResponse getRolesFor(
			@WebParam(name = "request", targetNamespace = "") final UserRequest request
	);
