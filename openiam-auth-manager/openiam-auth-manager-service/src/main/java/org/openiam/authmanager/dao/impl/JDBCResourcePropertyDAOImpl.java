...
public class JDBCResourcePropertyDAOImpl extends AbstractJDBCDao implements ResourcePropDAO {
	...
	private static String GET_ALL = "SELECT RESOURCE_PROP_ID AS ID, RESOURCE_ID AS RESOURCE_ID, METADATA_ID AS METADATA_ID, NAME AS NAME, ATTR_VALUE AS VALUE FROM %s.RESOURCE_PROP";
