...
public class AcceptEntitlementsNotifierDelegate extends AbstractEntitlementsDelegate {
	...
	static {
		...
		NOTIFICATION_MAP.put("DELETE_RESOURCE", "DELETE_RESOURCE_ACCEPT");
		NOTIFICATION_MAP.put("NEW_RESOURCE", "NEW_RESOURCE_ACCEPT");
		
		
		NOTIFICATION_MAP.put("NEW_GROUP", "NEW_GROUP_ACCEPT");
		NOTIFICATION_MAP.put("EDIT_GROUP", "EDIT_GROUP_ACCEPT");
		NOTIFICATION_MAP.put("DELETE_GROUP", "DELETE_GROUP_ACCEPT");
		
		NOTIFICATION_MAP.put("NEW_ROLE", "NEW_ROLE_ACCEPT");
		NOTIFICATION_MAP.put("EDIT_ROLE", "EDIT_ROLE_ACCEPT");
		NOTIFICATION_MAP.put("DELETE_ROLE", "DELETE_ROLE_ACCEPT");
		
		NOTIFICATION_MAP.put("NEW_ORGANIZTION", "NEW_ORGANIZTION_ACCEPT");
		NOTIFICATION_MAP.put("EDIT_ORGANIZTION", "EDIT_ORGANIZTION_ACCEPT");
		NOTIFICATION_MAP.put("DELETE_ORGANIZATION", "DELETE_ORGANIZATION_ACCEPT");
	}
