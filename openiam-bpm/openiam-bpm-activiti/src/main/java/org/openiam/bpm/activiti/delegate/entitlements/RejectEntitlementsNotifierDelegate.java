...
public class RejectEntitlementsNotifierDelegate extends AbstractNotificationDelegate {
	...
	static {
        ...
        NOTIFICATION_MAP.put(ActivitiRequestType.REPLACE_SUPERIOR, "REPLACE_SUPERIOR_REJECT");
		...
		NOTIFICATION_MAP.put(ActivitiRequestType.ADD_GROUP_TO_GROUP, "ADD_GROUP_TO_GROUP_REJECT");
		NOTIFICATION_MAP.put(ActivitiRequestType.ADD_ROLE_TO_GROUP, "ADD_ROLE_TO_GROUP_REJECT");
		NOTIFICATION_MAP.put(ActivitiRequestType.ENTITLE_RESOURCE_TO_GROUP, "ENTITLE_RESOURCE_TO_GROUP_REJECT");
		NOTIFICATION_MAP.put(ActivitiRequestType.ADD_ROLE_TO_ROLE, "ADD_ROLE_TO_ROLE_REJECT");
		NOTIFICATION_MAP.put(ActivitiRequestType.ENTITLE_RESOURCE_TO_ROLE, "ENTITLE_RESOURCE_TO_ROLE_REJECT");
		NOTIFICATION_MAP.put(ActivitiRequestType.ADD_RESOURCE_TO_RESOURCE, "ADD_RESOURCE_TO_RESOURCE_REJECT");
		
		NOTIFICATION_MAP.put(ActivitiRequestType.REMOVE_GROUP_FROM_GROUP, "REMOVE_GROUP_FROM_GROUP_REJECT");
		NOTIFICATION_MAP.put(ActivitiRequestType.REMOVE_ROLE_FROM_GROUP, "REMOVE_ROLE_FROM_GROUP_REJECT");
		NOTIFICATION_MAP.put(ActivitiRequestType.DISENTITLE_RESOURCE_FROM_GROUP, "DISENTITLE_RESOURCE_FROM_GROUP_REJECT");
		...
		NOTIFICATION_MAP.put(ActivitiRequestType.ROLE_CERTIFICATION, "RESOURCE_CERTIFICATION_REJECT");
	}
