...
public abstract class AbstractEntitlementsDelegate extends AbstractNotificationDelegate {
	...
	static {
		...
		NOTIFICATION_MAP.put("NEW_ORGANIZTION", "NEW_ORGANIZTION_NOTIFY");
		NOTIFICATION_MAP.put("EDIT_ORGANIZTION", "EDIT_ORGANIZTION_NOTIFY");
		NOTIFICATION_MAP.put("DELETE_ORGANIZATION", "DELETE_ORGANIZATION_NOTIFY");
	}
