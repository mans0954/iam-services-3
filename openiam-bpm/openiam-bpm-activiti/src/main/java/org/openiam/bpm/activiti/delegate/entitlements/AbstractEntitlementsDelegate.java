...
public abstract class AbstractEntitlementsDelegate extends AbstractNotificationDelegate {
	...
	static {
        ...
        NOTIFICATION_MAP.put(ActivitiRequestType.REPLACE_SUPERIOR, "REPLACE_SUPERIOR_NOTIFY");
		...
		NOTIFICATION_MAP.put(ActivitiRequestType.ROLE_CERTIFICATION, "RESOURCE_CERTIFICATION_NOTIFY");
	}
