...
/**
 * Constants that are used by the request-approval services.
 * @author suneet
 *
 */
public class ProvisioningConstants {
	public static final String NEW_HIRE = "NEW_HIRE";
	public static final String CHANGE_ACCESS="CHANGE_ACCESS";
