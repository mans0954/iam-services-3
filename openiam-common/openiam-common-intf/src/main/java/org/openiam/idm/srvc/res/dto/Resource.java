...
/**
 * Resources are items that need to be managed or protected. These can be both
 * logic and physical in nature.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Resource", propOrder = { "resourceType", "resourceId", "name",
		"description", "branchId", "categoryId", "displayOrder",
		"managedSysId", "URL", "resourceRoles", "resourceProps",
		"resourceGroups", "resOwnerUserId", "resOwnerGroupId",
		"childResources", "parentResources", "minAuthLevel", "domain",
		"isPublic", "isSSL" })
...
public class Resource extends BaseObject {
	...
	private Set<ResourceProp> resourceProps = new HashSet<ResourceProp>(0); // defined
																			// as
																			// a
																			// Set
																			// in
	...
	public String toString() {
		return "Resource{" + "resourceId='" + resourceId + '\''
				...
				+ ", description='" + description + '\'' + ", branchId='"
				+ branchId + '\'' + ", categoryId='" + categoryId + '\''
				+ ", displayOrder=" + displayOrder + ", managedSysId='"
				+ managedSysId + '\'' + ", URL='" + URL + '\''
				+ ", resOwnerUserId='" + resOwnerUserId + '\''
				+ ", resOwnerGroupId='" + resOwnerGroupId + '\''
				+ ", resourceRoles=" + resourceRoles + ", resourceProps="
				+ resourceProps + ", resourceGroups=" + resourceGroups +
	...
	/*
	 * public Set<ResourcePrivilege> getEntitlements() { return entitlements; }
	 * 
