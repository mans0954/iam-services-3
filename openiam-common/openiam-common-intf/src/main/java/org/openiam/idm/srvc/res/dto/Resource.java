...
@XmlType(name = "Resource", propOrder = {"resourceType", "description", "displayOrder", "URL", "roles", "resourceProps", "groups", "childResources", "parentResources", "minAuthLevel", "isPublic", "operation", "risk", "displayNameMap", "displayName", "coorelatedName"})
@XmlSeeAlso({Role.class, User.class})
...
public class Resource extends AbstractEntitlementsDTO {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((coorelatedName == null) ? 0 : coorelatedName.hashCode());
        result = prime * result + ((description == null) ? 0 : description.hashCode());
        result = prime * result + ((displayOrder == null) ? 0 : displayOrder.hashCode());
        result = prime * result + (isPublic ? 1231 : 1237);
        result = prime * result + ((minAuthLevel == null) ? 0 : minAuthLevel.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (coorelatedName == null) {
            if (other.coorelatedName != null) return false;
        } else if (!coorelatedName.equals(other.coorelatedName)) return false;
        if (description == null) {
            if (other.description != null) return false;
        } else if (!description.equals(other.description)) return false;
        if (displayOrder == null) {
            if (other.displayOrder != null) return false;
        } else if (!displayOrder.equals(other.displayOrder)) return false;
        if (isPublic != other.isPublic) return false;
        if (minAuthLevel == null) {
            if (other.minAuthLevel != null) return false;
        } else if (!minAuthLevel.equals(other.minAuthLevel)) return false;
