...
//	@Fetch(FetchMode.SUBSELECT)
    ...
    public RoleToRoleMembershipXrefEntity getChild(final String childId) {
        RoleToRoleMembershipXrefEntity retVal = null;
        if (this.getChildRoles() != null) {
            for (RoleToRoleMembershipXrefEntity xrefEntity : this.getChildRoles()) {
                if (xrefEntity.getMemberEntity() != null && xrefEntity.getMemberEntity().getId().equals(childId)) {
                    retVal = xrefEntity;
                    break;
                }
            }
    ...
    public RoleToRoleMembershipXrefEntity getParent(final String parentId) {
        RoleToRoleMembershipXrefEntity retVal = null;
        if (this.getParentRoles() != null) {
            for (RoleToRoleMembershipXrefEntity xrefEntity : this.getParentRoles()) {
                if (xrefEntity.getEntity() != null && xrefEntity.getEntity().getId().equals(parentId)) {
                    retVal = xrefEntity;
                    break;
                }
            }
    ...
    public void removeResource(final ResourceEntity entity) {
        if (entity != null) {
            if (this.resources != null && entity.getId() != null) {
                Iterator<RoleToResourceMembershipXrefEntity> xrefEntityIterator = resources.iterator();
                while (xrefEntityIterator.hasNext()) {
                    RoleToResourceMembershipXrefEntity xrefEntity = xrefEntityIterator.next();
                    if (xrefEntity.getMemberEntity() != null && xrefEntity.getMemberEntity().getId().equals(entity.getId())) {
                        xrefEntityIterator.remove();
                        break;
                    }
                }
            }
    ...
    public boolean hasChild(final RoleEntity entity) {
        ...
        if (childRoles != null && entity != null && entity.getId() != null) {
            contains = this.getChild(entity.getId()) != null;
        }
        return contains;
    }
    ...
    public void removeChild(final RoleEntity entity) {
        if (entity != null) {
            if (this.childRoles != null && entity.getId() != null) {
                Iterator<RoleToRoleMembershipXrefEntity> xrefEntityIterator = childRoles.iterator();
                while (xrefEntityIterator.hasNext()) {
                    RoleToRoleMembershipXrefEntity xrefEntity = xrefEntityIterator.next();
                    if (xrefEntity.getMemberEntity() != null && xrefEntity.getMemberEntity().getId().equals(entity.getId())) {
                        xrefEntityIterator.remove();
                        break;
                    }
    ...
    public RoleToResourceMembershipXrefEntity getResource(final String resourceId) {
        ...
        if (this.getResources() != null) {
            for (RoleToResourceMembershipXrefEntity xrefEntity : this.getResources()) {
                if (xrefEntity.getMemberEntity() != null && xrefEntity.getMemberEntity().getId().equals(resourceId)) {
                    retVal = xrefEntity;
                    break;
                }
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (managedSystem == null) {
            if (other.managedSystem != null) return false;
        } else if (!managedSystem.equals(other.managedSystem)) return false;
        if (id == null) {
    ...
    public String toString() {
        return String.format("RoleEntity [id=%s, name=%s, description=%s, status=%s, managedSystem=%s, createDate=%s, createdBy=%s]", id, name, description, status, managedSystem, createDate, createdBy);
    }
