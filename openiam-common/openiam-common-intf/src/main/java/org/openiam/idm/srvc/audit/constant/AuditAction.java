...
public enum AuditAction {
    ...
    EDIT_ROLE("EDIT ROLE"),
    ADD_ROLE_POLICY("ADD ROLE XACML_POLICY"),
    UPDATE_ROLE_POLICY("UPDATE ROLE XACML_POLICY"),
    GET_ROLE_POLICY("GET ROLE XACML_POLICY"),
    REMOVE_ROLE_POLICY("REMOVE ROLE XACML_POLICY"),
