...
public enum AuditAction {
    ...
    SAVE_RESOURCE_TYPE("SAVE_RESOURCE_TYPE"),
    ...
    SEND_EMAIL_ON_CREATE_USER("SEND EMAIL ON CREATE USER"),
    ...
    REPLACE_USER_FROM_ORG ("REPLACE_USER_FROM_ORG"),
    ...
    SAVE_CHALLENGE_ANSWERS("SAVE_CHALLENGE_ANSWERS"),
    CHANGE_CHALLENGE_ANSWERS("CHANGE_CHALLENGE_ANSWERS"),
    VIEW_CHALLENGE_ANSWERS("VIEW_CHALLENGE_ANSWERS"),

    ADD_ACCESS_RIGHT("ADD ACCESS RIGHT"),
    UPDATE_ACCESS_RIGHT("UPDATE ACCESS RIGHT"),
    DELETE_ACCESS_RIGHT("DELETE ACCESS RIGHT"),
	;
