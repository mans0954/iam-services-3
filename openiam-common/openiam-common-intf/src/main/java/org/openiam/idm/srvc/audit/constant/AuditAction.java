...
public enum AuditAction {
    ...
    PROVISIONING_DISPATCHER("PROVISIONING_DISPATCHER"),
    PROVISIONING_ADD("PROV_ADD"),
    PROVISIONING_MODIFY("PROV_MODIFY"),
    PROVISIONING_RESETPASSWORD("PROV_RESETPASSWD"),
    PROVISIONING_LOOKUP("PROV_LOOKUP"),
    PROVISIONING_TEST("PROV_TEST"),
    PROVISIONING_DELETE("PROV_DELETE"),
    SYNCHRONIZATION("SYNCHRONIZATION"),
    SYNCH_USER("SYNCH_USER"),
    RECONCILIATION("RECONCILIATION"),
    RECONCILIATION_IDM_USER("RECONCILIATION_IDM_USER"),
    RECONCILIATION_SOURCE_USER("RECONCILIATION_SOURCE_USER"),

    GET_RESOURCE_FOR_USER_BY_TYPE("GET RESOURCE FOR USER BY RESOURCE TYPE"),
    
    BATCH_TASK_EXECUTE("IDM BATCH TASK"),
    
    MENU_AUTHORIZATON("MENU_AUTHORIZATON"),
    ...
    SSL_CERT_REQUEST("SSL_CERT_REQUEST")
    ;
