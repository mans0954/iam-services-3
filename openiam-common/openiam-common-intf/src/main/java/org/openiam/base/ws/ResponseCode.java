...
public enum ResponseCode {
    ...
    @XmlEnumValue("CERT_WAS_REVOKED")
    CERT_WAS_REVOKED("CERT_WAS_REVOKED"),

    @XmlEnumValue("CERT_CRL_VERIFY_EXCEPTION")
    CERT_CRL_VERIFY_EXCEPTION("CERT_CRL_VERIFY_EXCEPTION"),

    @XmlEnumValue("CERT_CRL_DOWNLOAD_EXCEPTION")
    CERT_CRL_DOWNLOAD_EXCEPTION("CERT_CRL_DOWNLOAD_EXCEPTION"),
