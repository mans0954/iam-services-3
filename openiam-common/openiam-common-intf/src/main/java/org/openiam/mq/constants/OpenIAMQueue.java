...
public enum OpenIAMQueue {
    ...
    ResourceQueue,
    ActivitiQueue,
    AccessReviewQueue, ManagedSysQueue, AccessRightQueue, AMAdminQueue, AMMenuQueue, AMManagerQueue, AuthProviderQueue, AuthProviderAPI, AuthResourceAttributeQueue;
