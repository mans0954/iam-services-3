...
@WebService(endpointInterface = "org.openiam.idm.srvc.cat.ws.CategoryWebService", targetNamespace = "urn:idm.openiam.org/srvc/cat/service", portName = "CategoryWebServicePort", serviceName = "CategoryWebService")
