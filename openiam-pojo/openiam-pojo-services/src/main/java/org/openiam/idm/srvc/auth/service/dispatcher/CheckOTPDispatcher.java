 ...
 */
@Component
public class CheckOTPDispatcher extends AbstractAPIDispatcher<OTPServiceRequest, BooleanResponse,AuthenticationAPI> {
    @Autowired
    ...
    @Override
    protected BooleanResponse processingApiRequest(AuthenticationAPI openIAMAPI, OTPServiceRequest otpServiceRequest) throws BasicDataServiceException {
