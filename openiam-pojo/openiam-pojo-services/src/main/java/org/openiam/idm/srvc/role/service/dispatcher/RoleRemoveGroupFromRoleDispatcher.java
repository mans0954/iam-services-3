 ...
 */
@Component
public class RoleRemoveGroupFromRoleDispatcher extends AbstractRoleDispatcher<MembershipRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, MembershipRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.removeGroupFromRole(requestBody.getObjectId(), requestBody.getLinkedObjectId(),requestBody.getRequesterId());
