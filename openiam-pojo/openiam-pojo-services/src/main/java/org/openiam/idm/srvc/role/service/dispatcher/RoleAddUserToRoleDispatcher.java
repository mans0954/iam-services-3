 ...
 */
@Component
public class RoleAddUserToRoleDispatcher extends AbstractRoleDispatcher<MembershipRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, MembershipRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.addUserToRole(requestBody.getObjectId(), requestBody.getLinkedObjectId(),
