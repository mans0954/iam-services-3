 ...
 */
@Component
public class RoleAddGroupToRoleDispatcher extends AbstractRoleDispatcher<MembershipRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, MembershipRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.addGroupToRole(requestBody.getObjectId(), requestBody.getLinkedObjectId(), requestBody.getRequesterId(), requestBody.getRightIds(),
