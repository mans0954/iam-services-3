...
public abstract class AbstractOrganizationServicePrePostProcessor implements OrganizationServicePrePostProcessor {
    ...
    @Override
    public int save(Organization org, Map<String, Object> bindingMap, IdmAuditLog auditLog) {
        return OrganizationServicePrePostProcessor.SUCCESS;
    }

    @Override
    public int delete(String orgId, Map<String, Object> bindingMap, IdmAuditLog auditLog) {
        return OrganizationServicePrePostProcessor.SUCCESS;
    }
}
