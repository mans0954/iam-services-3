...
public class ChallengeResponseWebServiceImpl implements ChallengeResponseWebService {
	...
	public Integer getNumOfRequiredQuestions(String userId, String domainId) {
    	return challengeResponseService.getNumOfRequiredQuestions(userId, domainId);
	}
	...
	public List<UserIdentityAnswer> findAnswerBeans(final IdentityAnswerSearchBean searchBean, final int from, final int size) {
		final List<UserIdentityAnswerEntity> resultList = challengeResponseService.findAnswerBeans(searchBean, from, size);
    ...
    public boolean isResponseValid(String domainId, String userId, List<UserIdentityAnswer> newAnswerList) {
        ...
        return challengeResponseService.isResponseValid(domainId, userId, entityList);
