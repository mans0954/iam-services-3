 ...
 */
@Component
public class RoleRemoveUserFromRoleDispatcher extends AbstractRoleDispatcher<EntitleToRoleRequest, BooleanResponse> {
    public RoleRemoveUserFromRoleDispatcher() {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, EntitleToRoleRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.removeUserFromRole(requestBody.getRoleId(), requestBody.getLinkedObjectId(),
