 ...
 */
@Component
public class RoleRemoveUserFromRoleDispatcher extends AbstractRoleDispatcher<MembershipRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, MembershipRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.removeUserFromRole(requestBody.getObjectId(), requestBody.getLinkedObjectId(),
