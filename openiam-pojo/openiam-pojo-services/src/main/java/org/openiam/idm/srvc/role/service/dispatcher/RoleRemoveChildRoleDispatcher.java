 ...
 */
@Component
public class RoleRemoveChildRoleDispatcher extends AbstractRoleDispatcher<EntitleToRoleRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, EntitleToRoleRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.removeChildRole(requestBody.getRoleId(), requestBody.getLinkedObjectId());
