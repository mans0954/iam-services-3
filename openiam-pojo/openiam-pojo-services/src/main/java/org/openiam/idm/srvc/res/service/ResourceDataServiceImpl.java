...
public class ResourceDataServiceImpl extends AbstractBaseService implements ResourceDataService {
    ...
    public List<Resource> findBeans(final ResourceSearchBean searchBean, final int from, final int size, final Language language) {
        ...
        try {
            ...
            resourceList = resourceConverter.convertToDTOList(resultsEntities,
    ...
    @Override
    public Response saveResourceType(ResourceType resourceType, final String requestorId) {
        final Response response = new Response(ResponseStatus.SUCCESS);
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder.setAction(AuditAction.SAVE_RESOURCE);
        try {
            auditBuilder.setRequestorUserId(requestorId);
    ...
    public Response removeUserFromResource(final String resourceId, final String userId) {
        final Response response = new Response(ResponseStatus.SUCCESS);
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder.setAction(AuditAction.REMOVE_USER_FROM_RESOURCE).setTargetUser(userId)
                .setAuditDescription(String.format("Remove user %s from resource: %s", userId, resourceId));
        try {
    ...
    public Response addUserToResource(final String resourceId, final String userId) {
        final Response response = new Response(ResponseStatus.SUCCESS);
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder.setAction(AuditAction.ADD_USER_TO_RESOURCE).setTargetUser(userId)
                .setAuditDescription(String.format("Add user %s to resource: %s", userId, resourceId));
        try {
            if (resourceId == null || userId == null) {
                throw new BasicDataServiceException(ResponseCode.INVALID_ARGUMENTS, "ResourceId or UserId is not set");
            }
    ...
    public Response deleteResourceType(final String resourceTypeId) {
        final Response response = new Response(ResponseStatus.SUCCESS);
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder.setAction(AuditAction.DELETE_RESOURCE_TYPE);
        try {
    ...
    public Response addChildResource(final String resourceId, final String childResourceId) {
        ...
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder
                .setAction(AuditAction.ADD_CHILD_RESOURCE)
    ...
    public Response deleteChildResource(final String resourceId, final String memberResourceId) {
        ...
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder
                .setAction(AuditAction.REMOVE_CHILD_RESOURCE)
                .setTargetResource(resourceId)
                .setAuditDescription(
    ...
    public List<Resource> getResourcesForUserByType(final String userId, final String resourceTypeId, final ResourceSearchBean searchBean, final Language language) {
        ...
        auditBuilder.setAction(AuditAction.GET_RESOURCE_FOR_USER_BY_TYPE).setTargetUser(userId)
                .addAttribute(AuditAttributeName.RESOURCE_TYPE, resourceTypeId);
        try {
    ...
    public Response canAddUserToResource(String userId, String resourceId) {
        final Response response = new Response(ResponseStatus.SUCCESS);
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder.setAction(AuditAction.CAN_ADD_USER_TO_RESOURCE).setTargetUser(userId)
                .setAuditDescription(String.format("Check if user can be added to resource: %s", resourceId));
        try {
            if (resourceId == null || userId == null) {
    ...
    public Response canRemoveUserFromResource(String userId, String resourceId) {
        final Response response = new Response(ResponseStatus.SUCCESS);
        AuditLogBuilder auditBuilder = auditLogProvider.getAuditLogBuilder();
        auditBuilder.setAction(AuditAction.CAN_REMOVE_USER_FROM_RESOURCE).setTargetUser(userId)
                .setAuditDescription(String.format("Check if user can be removed from resource: %s", resourceId));
        try {
            if (resourceId == null || userId == null) {
                throw new BasicDataServiceException(ResponseCode.INVALID_ARGUMENTS, "ResourceId or UserId  is null");
            }
