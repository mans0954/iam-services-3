 ...
 */
@Component
public class RoleCanAddChildRoleDispatcher extends AbstractRoleDispatcher<MembershipRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, MembershipRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.validateRole2RoleAddition(requestBody.getObjectId(), requestBody.getLinkedObjectId(), requestBody.getRightIds(),
