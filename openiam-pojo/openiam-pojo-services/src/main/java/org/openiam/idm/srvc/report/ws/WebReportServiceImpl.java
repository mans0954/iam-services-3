 ...
 */
@Service("reportWS")
@WebService(endpointInterface = "org.openiam.idm.srvc.report.ws.WebReportService", targetNamespace = "urn:idm.openiam.org/idm/srvc/report/ws", portName = "ReportServicePort", serviceName = "ReportService")
