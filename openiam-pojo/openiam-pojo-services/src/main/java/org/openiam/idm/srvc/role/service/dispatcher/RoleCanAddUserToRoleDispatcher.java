 ...
 */
@Component
public class RoleCanAddUserToRoleDispatcher extends AbstractRoleDispatcher<MembershipRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, MembershipRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.canAddUserToRole(requestBody.getLinkedObjectId(), requestBody.getObjectId());
