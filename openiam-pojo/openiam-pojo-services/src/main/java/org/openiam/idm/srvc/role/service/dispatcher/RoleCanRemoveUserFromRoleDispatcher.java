 ...
 */
@Component
public class RoleCanRemoveUserFromRoleDispatcher extends AbstractRoleDispatcher<EntitleToRoleRequest, BooleanResponse> {
    ...
    protected BooleanResponse processingApiRequest(RoleAPI openIAMAPI, EntitleToRoleRequest requestBody) throws BasicDataServiceException {
        ...
        roleDataService.canRemoveUserFromRole(requestBody.getLinkedObjectId(), requestBody.getRoleId());
