...
public interface ResourceDataService {
	...
	*/
	...
	Response addResourceType(
			@WebParam(name = "resourceType", targetNamespace = "") ResourceType resourceType);
	...
	ResourceType getResourceType(
			@WebParam(name = "resourceTypeId", targetNamespace = "") String resourceTypeId);
	...
	@WebMethod
	List<Resource> getResourcesForManagedSys(
