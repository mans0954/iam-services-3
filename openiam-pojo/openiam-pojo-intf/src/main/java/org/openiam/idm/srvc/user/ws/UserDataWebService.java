...
public interface UserDataWebService {
	...
	public List<User> findUserByOrganization(
			@WebParam(name = "orgId", targetNamespace = "") String orgId);
	...
	public Response addAttribute(
			@WebParam(name = "attribute", targetNamespace = "") UserAttribute attribute);
	...
	public UserAttribute getAttribute(
			@WebParam(name = "attrId", targetNamespace = "") String attrId);
	...
	public Response removeAttribute(
			@WebParam(name = "attr", targetNamespace = "") String attrId);
	...
	public Response addNote(
			@WebParam(name = "note", targetNamespace = "") UserNote note);
	...
	public UserNote getNote(
			@WebParam(name = "noteId", targetNamespace = "") java.lang.String noteId);
	...
	public Response removeNote(
			@WebParam(name = "note", targetNamespace = "") String noteId);
	...
	public Response addAddress(
			@WebParam(name = "address", targetNamespace = "") Address address);

	@WebMethod
	public Response addAddressSet(
			@WebParam(name = "addressSet", targetNamespace = "") Set<Address> addressSet);
	...
	public Response removeAddress(
			@WebParam(name = "address", targetNamespace = "") String addressId);
	...
	public Address getAddressById(
			@WebParam(name = "addressId", targetNamespace = "") String addressId);
	...
	@WebMethod
	public List<Address> getAddressListByPage(
			@WebParam(name = "userId", targetNamespace = "") String userId,
	...
	public Response addPhone(
			@WebParam(name = "phone", targetNamespace = "") Phone phone);
	...
	public Response removePhone(
			@WebParam(name = "phone", targetNamespace = "") String phoneId);
	...
	@WebMethod
	public List<Phone> getPhoneListByPage(
			@WebParam(name = "userId", targetNamespace = "") String userId,
			@WebParam(name = "size", targetNamespace = "") Integer size,
			@WebParam(name = "from", targetNamespace = "") Integer from);
	...
	public Response addEmailAddress(
			@WebParam(name = "email", targetNamespace = "") EmailAddress email);

	@WebMethod
	public Response addEmailAddressSet(
			@WebParam(name = "emailAddressSet", targetNamespace = "") Set<EmailAddress> emailAddressSet);
	...
	public Response removeEmailAddress(
			@WebParam(name = "email", targetNamespace = "") String emailId);
	...
	@WebMethod
	public List<EmailAddress> getEmailAddressListByPage(
			@WebParam(name = "userId", targetNamespace = "") String userId,
			@WebParam(name = "size", targetNamespace = "") Integer size,
			@WebParam(name = "from", targetNamespace = "") Integer from);
	...
	public Response addSupervisor(
			@WebParam(name = "supervisor", targetNamespace = "") Supervisor supervisor);
	...
	public Response removeSupervisor(
			@WebParam(name = "supervisor", targetNamespace = "") String supervisorId);

	@WebMethod
	public Supervisor getSupervisor(
			@WebParam(name = "supervisorObjId", targetNamespace = "") String supervisorObjId);
	...
	public List<Supervisor> getEmployees(
			@WebParam(name = "supervisorId", targetNamespace = "") String supervisorId);
	...
	@WebMethod
	public List<User> getUsersForResource(
	...
	@WebMethod
	public int getNumOfUsersForResource(
			@WebParam(name = "resourceId", targetNamespace = "") final String resourceId);
	...
	@WebMethod
	public int getNumOfUsersForGroup(
			@WebParam(name = "groupId", targetNamespace = "") final String groupId);
	...
	@WebMethod
	public int getNumOfUsersForRole(
			@WebParam(name = "roleId", targetNamespace = "") final String roleId);

	@WebMethod
	public UserResponse saveUserInfo(
			@WebParam(name = "user", targetNamespace = "") final User user,
	...
	@WebMethod
	public Response enableDisableUser(
			@WebParam(name = "userId", targetNamespace = "") final String userId,
	...
	@WebMethod
	public Integer getNumOfEmailsForUser(
			@WebParam(name = "userId", targetNamespace = "") String userId);

	@WebMethod
	public Integer getNumOfAddressesForUser(
			@WebParam(name = "userId", targetNamespace = "") String userId);

	@WebMethod
	public Integer getNumOfPhonesForUser(
			@WebParam(name = "userId", targetNamespace = "") String userId);

	@WebMethod
	public SaveTemplateProfileResponse saveUserProfile(
			@WebParam(name = "request", targetNamespace = "") final UserProfileRequestModel request);

	@WebMethod
	public SaveTemplateProfileResponse createNewUserProfile(
			@WebParam(name = "request", targetNamespace = "") final NewUserProfileRequestModel request);

	@WebMethod
	public Response sendNewUserEmail(
			@WebParam(name = "userId", targetNamespace = "") final String userId,
			@WebParam(name = "password", targetNamespace = "") final String password,
			@WebParam(name = "login", targetNamespace = "") final String login);

	@WebMethod
	public List<User> getByManagedSystem(
			@WebParam(name = "mSysId", targetNamespace = "") final String mSysId);
}