...
public enum ResponseCode {
    ...
    AUTH_RESOURCE_AM_ATTRIBUTE_NOT_SET(""),
    AUTH_RESOURCE_AM_ATTRIBUTE_ID_NOT_SET(""),
    AUTH_RESOURCE_AM_ATTRIBUTE_NAME_NOT_SET(""),
    AUTH_RESOURCE_ATTRIBUTE_MAP_NOT_SET(""),
    AUTH_RESOURCE_TARGET_ATTRIBUTE_NOT_SET(""),
    AUTH_RESOURCE_ATTRIBUTE_MAP_COLLECTION_NOT_SET(""),
    AUTH_RESOURCE_ATTRIBUTE_MAP_ID_NOT_SET("");
