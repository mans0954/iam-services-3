...
public class ManagedSystemWebServiceImpl implements ManagedSystemWebService {
    ...
    public ManagedSysDto getManagedSys(String sysId) {
        return managedSystemService.getManagedSys(sysId);
    }

    @Transactional(readOnly = true)
    @Override
    public List<ManagedSysDto> getAllManagedSys() {
        return managedSystemService.getAllManagedSysDTO();
    }
    ...
    public ManagedSystemObjectMatch[] managedSysObjectParam(String managedSystemId, String objectType) {
        return managedSystemService.managedSysObjectParamDTO(managedSystemId, objectType);
    }

    @Override
    @Transactional(readOnly = true)
    public ManagedSysDto getManagedSysByResource(String resourceId) {
        return managedSystemService.getManagedSysDtoByResource(resourceId);
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.openiam.srvc.idm.ManagedSystemWebService#
    ...
    public List<AttributeMap> getResourceAttributeMaps(final String resourceId) {
        return managedSystemService.getResourceAttributeMapsDTO(resourceId);
    }
