...
import org.openiam.base.response.SynchConfigListResponse;
 ...
 * @author suneet
 */
@WebService(endpointInterface = "org.openiam.srvc.idm.IdentitySynchWebService",
...
public class IdentitySynchWebServiceImpl implements IdentitySynchWebService {
    ...
    /* (non-Javadoc)
     * @see org.openiam.srvc.idm.IdentitySynchWebService#addConfig(org.openiam.idm.srvc.synch.dto.SynchConfig)
     */
    ...
    /* (non-Javadoc)
    * @see org.openiam.srvc.idm.IdentitySynchWebService#findById(java.lang.String)
    */
    ...
    /* (non-Javadoc)
     * @see org.openiam.srvc.idm.IdentitySynchWebService#removeConfig(java.lang.String)
     */
    ...
    public List<AttributeMap> getSynchConfigAttributeMaps(String synchConfigId) {
        return synchService.getSynchConfigAttributeMapsDTO(synchConfigId);
    }
