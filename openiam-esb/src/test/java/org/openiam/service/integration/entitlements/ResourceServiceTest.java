...
public class ResourceServiceTest extends AbstractAttributeServiceTest<Resource, ResourceSearchBean, ResourceProp> {
	...
	@Override
	protected String getId(Resource bean) {
		return bean.getId();
	}

	@Override
	protected void setId(Resource bean, String id) {
		bean.setId(id);
	}

	@Override
	protected void setName(Resource bean, String name) {
		bean.setName(name);
	}

	@Override
	protected String getName(Resource bean) {
		return bean.getName();
	}

	@Override
	protected void setNameForSearch(ResourceSearchBean searchBean, String name) {
