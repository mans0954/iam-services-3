...
import org.openiam.listener.IdentityTestListener;
...
@Listeners({IdentityTestListener.class})
...
public abstract class AbstractServiceTest extends AbstractTestNGSpringContextTests {
	...
	protected Organization createOrganization() {
		...
		organization = organizationServiceClient.getOrganization((String)wsResponse.getResponseValue());
