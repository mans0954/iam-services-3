...
/*    private void returnDefaultPolicyAssocc() throws Exception {
    ...
    private List<String> createPolicy() throws Exception {
        ...
        for (PolicyDefParam param : allDefaultPolicies) {
            if (param.getPolicyDefId().equals("112")) {
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
            ...
            if (param.getPolicyDefId().equals("110")){
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
                attribute.setName(param.getName());
                attribute.setDescription(param.getDescription());
            ...
            if (param.getPolicyDefId().equals("114")){
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
                attribute.setName(param.getName());
                attribute.setDescription(param.getDescription());
            ...
            if (param.getPolicyDefId().equals("115")){
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
                attribute.setName(param.getName());
                attribute.setDescription(param.getDescription());
            ...
            if (param.getPolicyDefId().equals("116")){
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
                attribute.setName(param.getName());
                attribute.setDescription(param.getDescription());
            ...
            if (param.getPolicyDefId().equals("130")){
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
                attribute.setName(param.getName());
                attribute.setDescription(param.getDescription());
            ...
            if (param.getPolicyDefId().equals("171")){
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
                attribute.setName(param.getName());
                attribute.setDescription(param.getDescription());
            ...
            //--------------------------------------------------
            if (!param.getPolicyDefId().equals("112") && !param.getPolicyDefId().equals("110")
                    && !param.getPolicyDefId().equals("114") && !param.getPolicyDefId().equals("115")
                    && !param.getPolicyDefId().equals("116") && !param.getPolicyDefId().equals("130")
                    && !param.getPolicyDefId().equals("171")) {
                PolicyAttribute attribute = new PolicyAttribute();
                attribute.setDefParamId(param.getPolicyDefId());
                attribute.setName(param.getName());
                attribute.setDescription(param.getDescription());
