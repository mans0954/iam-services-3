...
public abstract class AbstractMetadataTypeServiceTest<T extends AbstractMetadataTypeDTO, S  extends AbstractSearchBean<T, String>> extends AbstractKeyNameServiceTest<T, S> {
