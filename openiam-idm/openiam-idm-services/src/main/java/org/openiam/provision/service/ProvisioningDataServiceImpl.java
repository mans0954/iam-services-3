    ...
    private ProvisionUserResponse deleteUserWithSkipManagedSysList(String managedSystemId, String principal, UserStatusEnum status, List<String> skipManagedSysList, IdmAuditLogEntity auditLog) {
        ...
        try {
            ...
            if (!managedSystemId.equals(sysConfiguration.getDefaultManagedSysId())) {
                final IdmAuditLogEntity idmAuditLogChild = auditLogHelper.newInstance();
    ...
    private ProvisionUserResponse addModifyUser(final ProvisionUser pUser, 
        ...
        if (!isAdd) {
            ...
            for (Resource res : resourceSet) {
                ...
                String managedSysId = managedSystemService.getManagedSysByResource(res.getId(), "ACTIVE").getId();
            ...
            for (LoginEntity l : userEntity.getPrincipalList()) {
                ...
                String resId = managedSystemService.getManagedSysById(l.getManagedSysId()).getResource().getId();
        ...
        try {
            if (passwordSync.getUserActivateFlag()) {
                ...
                for (final LoginEntity lg : principalList) {
                    ...
                    if (mSys != null) {
                        final ResourceEntity res = resourceService.findResourceById(mSys.getResource().getId());
                        if(log.isDebugEnabled()) {
	                        log.debug(" - Managed System Id = " + managedSysId);
	                        log.debug(" - Resource Id = " + res.getId());
                        }
                        final boolean retval = loginManager.resetPassword(lg.getLogin(), lg.getManagedSysId(), passwordSync.getContentProviderId(), encPassword, passwordSync.getUserActivateFlag());
                        ...
                        final IdmAuditLogEntity childAuditLog = auditLogHelper.newInstance();
...
//                        idmAuditLog.succeed();
            ...
            try {
                ...
                for (String userId : bulkRequest.getUserIds()) {
                    ...
                    if (user != null) {
                        ...
                        final Set<String> existingGroups = (pUser.getGroups() != null) ?
                        ...
                        final Set<String> existingRoles = (pUser.getRoles() != null) ?
                        ...
                        final Set<String> existingOrganizations = (pUser.getAffiliations() != null) ?
                        ...
                        final Set<String> existingResources = (pUser.getResources() != null) ?
                            ...
                            switch (ob.getObjectType()) {
                                ...
                                case RESOURCE:
                                    ...
                                    if (existingResources.contains(resource)) {
                                        ...
                                        if (BulkOperationEnum.ADD_ENTITLEMENT.equals(ob.getOperation())) {
                                            existingResources.add(resource.getId());
                                ...
                                case ORGANIZATION:
                                    ...
                                    while (organizationUserDTOIterator.hasNext()) {
                                        String organizationUserDTO = organizationUserDTOIterator.next();
                                        String organz = organizationUserDTO;
                                        if (organz.equals(ob.getObjectId())) {
                                    ...
                                    if (toDelete) {
                                        ...
                                        if (BulkOperationEnum.ADD_ENTITLEMENT.equals(ob.getOperation())) {
                                            ...
                                            existingOrganizations.add(organization.getId());
    ...
    public ManagedSystemViewerResponse buildManagedSystemViewer(String userId, String managedSysId) {
        ...
        ProvisionUser pUser = new ProvisionUser(usr);
        ExtensibleUser extensibleUser = buildPolicyMapHelper.buildMngSysAttributesForIDMUser(pUser,
                targetSysUserExists, mngSysAttrs, managedSysId, "VIEW");
 ...
 */
    ...
    public Response disableUser(String userId, boolean operation, IdmAuditLogEntity auditLog) {
        ...
        idmAuditLog.put(AuditAttributeName.DESCRIPTION, "callPreProcessor result="
                + (callPreProcessor == 1 ? "SUCCESS" : "FAIL"));
        if (callPreProcessor != ProvisioningConstants.SUCCESS) {
            idmAuditLog.fail();
        ...
        try {
            ...
            if (operation) {
                ...
                if(saveRehireChange.equalsIgnoreCase("true")) {
                    IdmAuditLogEntity childAuditLog = auditLogHelper.newInstance();
