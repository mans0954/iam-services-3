...
implements ProvisionService,  ApplicationContextAware  {
	...
	public ProvisionUserResponse addUser(ProvisionUser provUser) throws Exception {
        ...
        try {
            gmSysKey = (String)se.execute(bindingMap, "provision/globalManagerSyskey.groovy");
	...
	/* -- Temp hack -- */
	    ...
	    try {
		    networxId = (String)se.execute(bindingMap, "provision/networxId.groovy");
        } catch(ScriptEngineException e) {
            log.error(e);
        }
        String globalManagerId = null;
        try {
            globalManagerId = (String)se.execute(bindingMap, "provision/globalManagerId.groovy");
        } catch(ScriptEngineException e) {
            log.error(e);
        }
