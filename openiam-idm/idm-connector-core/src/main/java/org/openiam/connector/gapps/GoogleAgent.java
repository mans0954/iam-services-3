...
public class GoogleAgent {
    ...
    public AppsPropertyService getService(String adminEmail, String password, String domainName)
	...
	if (StringUtils.hasText(adminEmail) && StringUtils.hasText(password)) {
	    ...
	    service = new SingleSignOnService(domainName, "OPENIAM-GOOGLE-CONNECTOR");
    ...
    // get ALL USERS
    public List<GenericEntry> getAllUsers(String adminEmail, String password, String domain)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	return this.getAllUsers(this.getService(adminEmail, password, domain), domain);
    }

    public List<GenericEntry> getAllUsers(AppsPropertyService service, String domain)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	return retrieveAllPages(service, new URL(APP_URL_USER + domain));
    }

    // GET ALL GROUPS
    public List<GenericEntry> getAllGroup(String adminEmail, String password, String domain)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	return this.getAllGroup(this.getService(adminEmail, password, domain), domain);
    }

    public List<GenericEntry> getAllGroup(AppsPropertyService service, String domain)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	return retrieveAllPages(service, new URL(APP_URL_GROUP + domain));
    }

    private List<GenericEntry> retrieveAllPages(AppsPropertyService service, URL feedUrl) throws IOException,
	    ServiceException {
    ...
    public GenericEntry getUser(String adminEmail, String password, String domain, String email)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	return this.getEntity(adminEmail, password, domain, email, APP_URL_USER);
    }

    public GenericEntry getGroup(String adminEmail, String password, String domain, String group)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	...
	log.info("Google connector add run:" + newG.getAllProperties().get("groupId"));
    }

    public void addUserToGroup(String adminEmail, String password, String domain, String groupId, String userId)
	    throws AppsForYourDomainException, AuthenticationException, MalformedURLException, IOException,
	    ServiceException {
	...
	this.getService(adminEmail, password, domain).insert(
		new URL("https://apps-apis.google.com/a/feeds/group/2.0/" + domain + "/" + groupId + "/member"), user);
    }

    public void deleteUserFromGroup(String adminEmail, String password, String domain, String groupId, String userId)
	    throws AppsForYourDomainException, AuthenticationException, MalformedURLException, IOException,
	    ServiceException {
	this.getService(adminEmail, password, domain).delete(
		new URL("https://apps-apis.google.com/a/feeds/group/2.0/" + domain + "/" + groupId + "/member/"
			+ userId));
    }

    public void updateUser(String adminEmail, String password, String domain, Map<String, String> googleUserProps,
	    String id) throws AppsForYourDomainException, AuthenticationException, MalformedURLException, IOException,
	    ServiceException {
	GenericEntry entry = new GenericEntry();
	entry.addProperties(googleUserProps);
	GenericEntry newE = this.getService(adminEmail, password, domain).update(
		new URL(APP_URL_USER + domain + "/" + id + "@" + domain), entry);
	log.info("Google connector update run:" + newE.getAllProperties().get("userEmail"));
    }

    public void updateGroup(String adminEmail, String password, String domain, Map<String, String> googleGroupProps,
	    String id) throws AppsForYourDomainException, AuthenticationException, MalformedURLException, IOException,
	    ServiceException {
	GenericEntry entry = new GenericEntry();
	entry.addProperties(googleGroupProps);
	GenericEntry newE = this.getService(adminEmail, password, domain).update(
		new URL(APP_URL_GROUP + domain + "/" + id + "@" + domain), entry);
	log.info("Google connector update run:" + newE.getAllProperties().get("groupId"));
    }

    public void deleteUser(String adminEmail, String password, String domain, String email)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	this.getService(adminEmail, password, domain).delete(
		new URL(APP_URL_USER + domain + "/" + email + "@" + domain));
    }

    public void deleteGroup(String adminEmail, String password, String domain, String groupName)
	    throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
	this.getService(adminEmail, password, domain).delete(
		new URL(APP_URL_GROUP + domain + "/" + groupName + "@" + domain));
    }
