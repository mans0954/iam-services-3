 ...
 */
public abstract class AbstractCrudGoogleAppsCommand<ExtObject extends ExtensibleObject> extends AbstractGoogleAppsCommand<CrudRequest<ExtObject>, ObjectResponse> {
    @Override
    ...
    protected abstract void performObjectOperation(CrudRequest<ExtObject> crudRequest, ManagedSysEntity managedSys)throws ConnectorDataException;
}
