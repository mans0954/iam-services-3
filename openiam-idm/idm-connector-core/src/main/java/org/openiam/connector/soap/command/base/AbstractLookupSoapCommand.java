 ...
 */
public abstract class AbstractLookupSoapCommand<ExtObject extends ExtensibleObject>
		extends AbstractSoapCommand<LookupRequest<ExtObject>, SearchResponse> {
	private static final Log log = LogFactory
			.getLog(AbstractLookupSoapCommand.class);
