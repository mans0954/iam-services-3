        ...
        if(response!=null){
            ...
            try {
                ...
                if (commandType == CommandType.DELETE ||
                        ...
                        commandType == CommandType.SET_PASSWORD || commandType == CommandType.TEST ||commandType==CommandType.ADD||commandType==CommandType.MODIFY || commandType==CommandType.SEARCH ||commandType==CommandType.LOOKUP) {
