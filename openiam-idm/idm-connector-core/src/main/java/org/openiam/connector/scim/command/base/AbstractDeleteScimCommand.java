 ...
 */
public abstract class AbstractDeleteScimCommand<ExtObject extends ExtensibleObject>
	...
	protected abstract void deleteObject(String dataId, HttpURLConnection con)
			throws ConnectorDataException;
}
