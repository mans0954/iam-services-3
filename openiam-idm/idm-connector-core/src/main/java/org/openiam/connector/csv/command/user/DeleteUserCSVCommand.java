...
import org.openiam.connector.csv.command.base.AbstractDeleteCSVCommand;
...
public class DeleteUserCSVCommand extends AbstractDeleteCSVCommand<ExtensibleUser> {
    @Autowired
    @Qualifier("userCSVParser")
    protected CSVParser<User> userCSVParser;

    @Override
    protected void deleteObject(String principal, ExtensibleUser object, ManagedSysEntity managedSys) throws ConnectorDataException {
        try {
