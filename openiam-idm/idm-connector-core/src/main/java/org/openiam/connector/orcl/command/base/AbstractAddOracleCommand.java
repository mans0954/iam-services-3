 ...
 */
public abstract class AbstractAddOracleCommand<ExtObject extends ExtensibleObject> extends AbstractOracleCommand<CrudRequest<ExtObject>, ObjectResponse> {
    @Override
...
//        }
        ...
        try {
            addObject(crudRequest,attributeMap,  con);
            return response;
    ...
    protected abstract void addObject(CrudRequest<ExtObject> crudRequest, List<AttributeMapEntity> attributeMap, Connection con) throws ConnectorDataException;
}
