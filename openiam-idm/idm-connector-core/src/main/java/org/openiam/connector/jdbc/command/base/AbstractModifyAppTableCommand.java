...
public abstract class AbstractModifyAppTableCommand<ExtObject extends ExtensibleObject> extends AbstractAppTableCommand<CrudRequest<ExtObject>, ObjectResponse> {
