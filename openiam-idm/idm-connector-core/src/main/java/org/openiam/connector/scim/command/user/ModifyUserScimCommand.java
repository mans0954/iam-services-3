...
public class ModifyUserScimCommand extends AbstractModifyScimCommand<ExtensibleUser> {
    ...
    protected void modifyObject(CrudRequest<ExtensibleUser> crudRequest, List<AttributeMapEntity> attributeMap, Connection con) throws ConnectorDataException {
    	//username cannot be altered in Scim yet, so dropping and creating user
