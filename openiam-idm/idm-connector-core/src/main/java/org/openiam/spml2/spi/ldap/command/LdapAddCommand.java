...
//            String ldapName = reqType.getObjectIdentity();
//
...
//
//
//            BasicAttributes basicAttr = getBasicAttributes(reqType.getExtensibleObject(), matchObj.getKeyField(),
...
//
//
//                dirSpecificImp.updateAccountMembership(targetMembershipList,ldapName,  matchObj, ldapctx, reqType.getExtensibleObject());
//            }
//
//
