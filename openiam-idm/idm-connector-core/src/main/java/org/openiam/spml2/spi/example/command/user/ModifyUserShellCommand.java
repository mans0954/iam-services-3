...
import org.openiam.spml2.spi.example.command.base.AbstractModifyShellCommand;
...
public class ModifyUserShellCommand extends AbstractModifyShellCommand<ProvisionUser> {
    @Override
    protected String getModifyCommand(String host, String hostlogin, String hostpassword, String objectId, List<ModificationType> modTypeList) {
